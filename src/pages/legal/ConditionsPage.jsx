    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 -mt-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-start gap-4">
          <Scale size={20} className="text-[#6b8a9a] shrink-0 mt-0.5" />
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-4">
        ...
        <div className="flex items-center justify-center gap-4 py-2 text-sm text-gray-400">
          <Link to="/" className="hover:text-[#6b8a9a] no-underline transition-colors">← Accueil</Link>
          <span>·</span>
          <Link to="/confidentialite" className="hover:text-[#6b8a9a] no-underline transition-colors">Confidentialité</Link>
          <span>·</span>
          <Link to="/faq" className="hover:text-[#6b8a9a] no-underline transition-colors">FAQ</Link>
        </div>
      </div>
    </div>
  )
