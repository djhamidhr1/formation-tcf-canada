...
const C = {
  icon: PenTool, label: 'Expression Ecrite',
  tagline: 'Demontrez votre capacite a rediger en francais. Maitrisez les 3 taches du TCF.',
  stats: ['60 min', '3 taches', '20 pts'],
  statLabels: ['Duree totale', 'Par serie', 'Score max'],
  main: 'var(--ee-main)', light: 'var(--ee-light)', text: 'var(--ee-text)',
  heroGrad: 'linear-gradient(145deg, var(--navy), var(--navy-mid))',
  info: 'Format : 3 taches de redaction (message, narration, argumentation)',
  tips: ['Respectez le nombre de mots demande', 'Structurez votre reponse clairement', 'Relisez pour corriger les fautes'],
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '40px 16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginTop: 36 }}>
          {[
            ...
            { to: C.subjectsLink, icon: FileText, title: "Sujets d'actualites", desc: '326 combinaisons de sujets reels du TCF' },
            { to: C.tipsLink, icon: Zap, title: 'Astuces & Bareme', desc: 'Strategies de redaction et guide de notation' },
          ].map(c => (
