...
import { Mic, Zap, BarChart2, FileText } from 'lucide-react'

const C = {
  icon: Mic, label: 'Expression Orale',
  tagline: "Maitrisez l epreuve orale du TCF Canada avec nos simulateurs et sujets d actualite.",
  stats: ['12 min', '3 taches', '20 pts'],
  statLabels: ['Duree totale', 'Par serie', 'Score max'],
  main: 'var(--eo-main)', light: 'var(--eo-light)', text: 'var(--eo-text)',
  heroGrad: 'linear-gradient(145deg, var(--navy), var(--navy-mid))',
  info: "Format : 3 taches (entretien dirige, interaction, point de vue)",
  tips: ['Preparez-vous 1 minute avant chaque tache', 'Parlez clairement et distinctement', 'Developpez vos arguments avec des exemples'],
  subjectsLink: '/epreuve/expression-orale/sujets-actualites',
  tipsLink: '/epreuve/expression-orale/astuces',
  dashLink: '/epreuve/expression-orale/tableau-de-bord',
}
      ...
      <div style={{ background: C.heroGrad, color: '#fff', padding: '64px 16px 48px' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 12 }}>
            <Link to={C.subjectsLink} style={{ background: '#fff', color: C.main, fontWeight: 700, padding: '12px 28px', borderRadius: 12, fontSize: 16, textDecoration: 'none' }}>
              Voir les sujets
            </Link>
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '40px 16px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 16, padding: 24 }}>
            ...
            <Link to={C.subjectsLink} style={{ display: 'inline-block', marginTop: 12, background: C.main, color: '#fff', fontWeight: 700, padding: '10px 24px', borderRadius: 10, fontSize: 14, textDecoration: 'none' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginTop: 36 }}>
          {[
            ...
            { to: C.subjectsLink, icon: FileText, title: "Sujets d'actualites", desc: '2855 sujets reels classes par mois et tache' },
