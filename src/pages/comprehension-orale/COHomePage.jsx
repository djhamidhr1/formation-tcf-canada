...
import { Headphones, Zap, BarChart2, Library } from 'lucide-react'

const C = {
  icon: Headphones, label: 'Comprehension Orale',
  tagline: 'Ecoutez des documents sonores authentiques. Maitrisez la comprehension auditive.',
  stats: ['35 min', '39 questions', '699 pts'],
  statLabels: ['Duree totale', 'Par serie', 'Score max'],
  main: 'var(--co-main)', light: 'var(--co-light)', text: 'var(--co-text)',
  heroGrad: 'linear-gradient(145deg, var(--navy), var(--navy-mid))',
  info: "Format : Documents sonores varies (dialogues, annonces, emissions)",
  tips: ['1 seule ecoute par document', 'Lisez les options avant d ecouter', 'Reperez les mots-cles a l oral'],
  seriesLink: '/epreuve/comprehension-orale/series',
  tipsLink: '/epreuve/comprehension-orale/astuces',
  dashLink: '/epreuve/comprehension-orale/tableau-de-bord',
}
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '40px 16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginTop: 36 }}>
          {[
            ...
            { to: C.seriesLink, icon: Library, title: 'Grille des series', desc: '40 series completes a votre disposition' },
